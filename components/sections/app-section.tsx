  ...
  <div className="container px-4 sm:px-6 md:px-0 relative z-10">
    ...
    <div className="text-center space-y-4 mb-12 md:mb-16">
      ...
      <p className="text-lg md:text-xl text-muted-foreground max-w-[800px] mx-auto px-2 sm:px-0">
        ...
        recompensas e fazer a diferença para o meio ambiente diretamente do seu smartphone.
      </p>
    </div>
        ...
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href={"/download/android"} className="flex-1">
              <Button size="lg" className="bg-primary py-4 hover:from-primary/90 hover:to-secondary/90 text-primary-foreground shadow-lg w-full">
                <i className="bi bi-android2 mr-2 h-5 w-5"></i>
                Download Android
              </Button>
            </Link>
            <Button disabled size="lg" variant="default" className="border-primary hover:bg-foreground/80 py-4 text-primary flex-1 w-full bg-foreground">
