...
export default function policePrivacyPage() {
  return (
    <>
    <Header/>
    <div className="px-6 sm:px-10 md:px-16 lg:px-20 py-10 md:py-16 lg:py-20">
    <Breadcrumb className='py-4 md:py-4'>
      <BreadcrumbList>
        ...
        <BreadcrumbItem>
          <BreadcrumbPage className='text-primary'>Politicas de Privacidade</BreadcrumbPage>
        </BreadcrumbItem>
      </BreadcrumbList>
    </Breadcrumb>
